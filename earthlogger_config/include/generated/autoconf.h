...
#define CONFIG_SYS_EXTRA_OPTIONS "IMX_CONFIG=board/mrd/earthlogger/earthlogger.cfg,MX6Q,DDR_SIZE=SZ_2G,ENV_IS_IN_MMC,MODULE_TYPE_PREFIX=\"imx6\",MODULE_TYPE_POSTFIX=\"max\""
